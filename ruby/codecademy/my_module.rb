...
# Create your own module called MyLibrary in the editor to the right. 
# Include a constant called FAVE_BOOK and set it equal to a string naming your favorite book!

module MyLibrary
  FAVE_BOOK = "Hasn't Been Written Yet"
end
