...
#!# Both of the solutions below passed RM, the second one is just a bit neater.

is_an_experienced_programmer = 
(candidate.years_of_experience >= 2 || candidate.github_points >= 500) && (candidate.languages_worked_with.include?('Ruby')) && (candidate.applied_recently? === false) && (candidate.age >= 15)

is_an_experienced_programmer = 
(candidate.years_of_experience >= 2 || candidate.github_points >= 500) && 
(candidate.languages_worked_with.include?('Ruby')) &&
!((candidate.applied_recently? === true) || (candidate.age < 15))
...
=begin 
STDOUT:
a programmer who has the 3 years of experience is accepted ✔
a programmer with 600 github points is accepted ✔
programmers who do not list Ruby among languages that they've worked with are not considered ✔
a programmer who has applied recently is not considered ✔
programmers with neither 2 years experience nor 500 Github points are not considered ✔
smart kids are sadly not considered ✔
=end